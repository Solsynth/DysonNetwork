...
namespace DysonNetwork.Passport.Migrations
{
    ...
    [Migration("20260307171723_RemoveAccountRelation")]
    partial class RemoveAccountRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnAccountBadge", b =>
                {
                    ...
                    b.Property<Guid?>("SnAccountId")
                        .HasColumnType("uuid")
                        .HasColumnName("sn_account_id");
                    ...
                    b.HasIndex("SnAccountId")
                        .HasDatabaseName("ix_badges_sn_account_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnSubscriptionReferenceObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_sn_subscription_reference_object");

                    b.ToTable("sn_subscription_reference_object", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnAccountBadge", b =>
                {
                    b.HasOne("DysonNetwork.Shared.Models.SnAccount", null)
                        .WithMany("Badges")
                        .HasForeignKey("SnAccountId")
                        .HasConstraintName("fk_badges_sn_account_sn_account_id");
                });
