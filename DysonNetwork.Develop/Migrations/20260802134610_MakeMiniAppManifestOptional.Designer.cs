...
namespace DysonNetwork.Develop.Migrations
{
    ...
    [Migration("20260802134610_MakeMiniAppManifestOptional")]
    partial class MakeMiniAppManifestOptional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DysonNetwork.Develop.Models.SnMiniApp", b =>
                {
                    ...
                    b.Property<string>("PackageStorageKey")
                        ...
                        .HasColumnName("package_storage_key");
                    ...
                    b.HasIndex("PluginId")
                        .IsUnique()
                        .HasDatabaseName("ix_mini_apps_plugin_id");
