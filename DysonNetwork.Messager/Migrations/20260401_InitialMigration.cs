        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mls_group_id = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    e2ee_policy = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    encryption_header = table.Column<byte[]>(type: "bytea", nullable: true),
                    encryption_signature = table.Column<byte[]>(type: "bytea", nullable: true),
                    encryption_scheme = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    encryption_epoch = table.Column<long>(type: "bigint", nullable: true),
                    encryption_message_type = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ...
                    reactions_count = table.Column<Dictionary<string, int>>(type: "jsonb", nullable: false),
