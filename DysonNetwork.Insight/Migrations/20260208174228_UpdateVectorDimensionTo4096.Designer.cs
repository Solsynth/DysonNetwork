...
namespace DysonNetwork.Insight.Migrations
{
    ...
    [Migration("20260208174228_UpdateVectorDimensionTo4096")]
    partial class UpdateVectorDimensionTo4096
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DysonNetwork.Insight.MiChan.MiChanInteraction", b =>
                {
                    ...
                    b.HasIndex("ContextId")
                        .HasDatabaseName("ix_mi_chan_interactions_context_id");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_mi_chan_interactions_created_at");

                    b.HasIndex("Embedding")
                        .HasDatabaseName("ix_mi_chan_interactions_embedding");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Embedding"), "hnsw");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Embedding"), new[] { "vector_cosine_ops" });

                    b.HasIndex("Type")
                        .HasDatabaseName("ix_mi_chan_interactions_type");
