...
namespace DysonNetwork.Padlock.Migrations
{
    ...
    [Migration("20260328123916_RemoveChatRoomIdFromMlsDeviceMembership")]
    partial class RemoveChatRoomIdFromMlsDeviceMembership
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnMlsDeviceMembership", b =>
                {
                    ...
                    b.HasIndex("MlsGroupId", "AccountId", "DeviceId")
                        .IsUnique()
                        .HasDatabaseName("ix_mls_device_memberships_mls_group_id_account_id_device_id");
