...
namespace DysonNetwork.Padlock.Migrations
{
    ...
    [Migration("20260713140242_RefactorPasskeys")]
    partial class RefactorPasskeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DysonNetwork.Padlock.Models.SnAccountPasskey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_account_passkeys");

                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_account_passkeys_account_id");

                    b.HasIndex("CredentialId")
                        .IsUnique()
                        .HasFilter("deleted_at IS NULL")
                        .HasDatabaseName("ix_account_passkeys_credential_id");

                    b.ToTable("account_passkeys", (string)null);
                });

            modelBuilder.Entity("DysonNetwork.Padlock.Models.SnAccountPunishment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Padlock.Models.SnAuthorizedApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnAuthChallenge", b =>
                {
                    ...
                    b.Property<Guid?>("ApprovedBySessionId")
                        .HasColumnType("uuid")
                        .HasColumnName("approved_by_session_id");
            ...
            modelBuilder.Entity("DysonNetwork.Padlock.Models.SnAccountPasskey", b =>
                {
                    b.HasOne("DysonNetwork.Shared.Models.SnAccount", "Account")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_account_passkeys_accounts_account_id");
