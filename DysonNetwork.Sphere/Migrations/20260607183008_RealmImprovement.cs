...
{
    /// <inheritdoc />
    public partial class RealmImprovement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_sn_realm_role_permission", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "sn_realm_user_permission",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    realm_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_sn_realm_user_permission", x => x.id);
                });
        }
