...
namespace DysonNetwork.Sphere.Migrations
{
    ...
    [Migration("20260410171411_AddOutboxFetchedAt")]
    partial class AddOutboxFetchedAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnAutomodRule", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ix_automod_rules_name");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnDiscoveryPreference", b =>
                {
                    ...
                    b.HasIndex("AccountId", "Kind", "ReferenceId")
                        .IsUnique()
                        .HasDatabaseName("ix_discovery_preferences_account_id_kind_reference_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnFediverseKey", b =>
                {
                    ...
                    b.HasIndex("KeyId")
                        .IsUnique()
                        .HasDatabaseName("ix_fediverse_keys_key_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostInterestProfile", b =>
                {
                    ...
                    b.HasIndex("AccountId", "Kind", "ReferenceId")
                        .IsUnique()
                        .HasDatabaseName("ix_post_interest_profiles_account_id_kind_reference_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPublishingSettings", b =>
                {
                    ...
                    b.HasIndex("AccountId")
                        .IsUnique()
                        .HasDatabaseName("ix_publishing_settings_account_id");
