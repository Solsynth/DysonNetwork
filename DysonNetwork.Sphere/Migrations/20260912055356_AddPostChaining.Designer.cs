...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPost", b =>
                {
                    ...
                    b.Property<Guid?>("ChainedPostId")
                        .HasColumnType("uuid")
                        .HasColumnName("chained_post_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostAggregatedStats", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("ActiveBidCount")
                        .HasColumnType("integer")
                        .HasColumnName("active_bid_count");

                    b.Property<decimal>("ActiveBidTotal")
                        .HasColumnType("numeric")
                        .HasColumnName("active_bid_total");
                    ...
                    b.Property<bool>("IsCurrentlyPlaced")
                        .HasColumnType("boolean")
                        .HasColumnName("is_currently_placed");

                    b.Property<Instant?>("LastShownAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_post_aggregated_stats");

                    b.HasIndex("PostId")
                        .IsUnique()
                        .HasDatabaseName("ix_post_aggregated_stats_post_id");

                    b.ToTable("post_aggregated_stats", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostBookmark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AccountId", "PostId", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("ix_post_bookmarks_account_id_post_id_deleted_at");

                    b.ToTable("post_bookmarks", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostCategorySubscription", b =>
                {
                    ...
                    b.HasIndex("CollectionId")
                        .HasDatabaseName("ix_post_category_subscriptions_collection_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostCollection", b =>
                {
                    ...
                    b.HasIndex("PublisherId", "Slug", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("ix_post_collections_publisher_id_slug_deleted_at");

                    b.ToTable("post_collections", (string)null);
                });

            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostCollectionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_post_collection_items");

                    b.HasIndex("PostId")
                        .HasDatabaseName("ix_post_collection_items_post_id");

                    b.HasIndex("CollectionId", "Order")
                        .HasDatabaseName("ix_post_collection_items_collection_id_order");

                    b.HasIndex("CollectionId", "PostId", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("ix_post_collection_items_collection_id_post_id_deleted_at");

                    b.ToTable("post_collection_items", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPublisherSubscription", b =>
                {
                    ...
                    b.HasIndex("AccountId", "PublisherId", "EndedAt")
                        .HasDatabaseName("ix_publisher_subscriptions_account_id_publisher_id_ended_at");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnRealmRolePermission", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_sn_realm_role_permission");

                    b.ToTable("sn_realm_role_permission", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnRealmUserPermission", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_sn_realm_user_permission");

                    b.ToTable("sn_realm_user_permission", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnSurveySubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_survey_subscriptions");

                    b.HasIndex("SurveyId")
                        .HasDatabaseName("ix_survey_subscriptions_survey_id");

                    b.HasIndex("AccountId", "SurveyId", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("ix_survey_subscriptions_account_id_survey_id_deleted_at");

                    b.ToTable("survey_subscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnActivityPubDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnAutomodRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnDiscoveryPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnFediverseModerationRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnLiveStreamAward", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnLiveStreamChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnPostIndex", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_post_indices");

                    b.HasIndex("PostId")
                        .IsUnique()
                        .HasDatabaseName("ix_post_indices_post_id");

                    b.ToTable("post_indices", (string)null);
                });

            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnPostInterestProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnPublisherVerifiedDomain", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_publisher_verified_domains");

                    b.HasIndex("PublisherId", "Domain")
                        .IsUnique()
                        .HasDatabaseName("ix_publisher_verified_domains_publisher_id_domain");

                    b.ToTable("publisher_verified_domains", (string)null);
                });
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPost", b =>
                {
                    ...
                    b.HasOne("DysonNetwork.Shared.Models.SnPost", "ChainedPost")
                        ...
                        .HasConstraintName("fk_posts_posts_chained_post_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostAggregatedStats", b =>
                {
                    b.HasOne("DysonNetwork.Shared.Models.SnPost", "Post")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_aggregated_stats_posts_post_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostCategorySubscription", b =>
                {
                    ...
                    b.HasOne("DysonNetwork.Shared.Models.SnPostCollection", "Collection")
                        .WithMany()
                        .HasForeignKey("CollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_post_category_subscriptions_post_collections_collection_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnPostCollectionItem", b =>
                {
                    b.HasOne("DysonNetwork.Shared.Models.SnPostCollection", "Collection")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_collection_items_post_collections_collection_id");
                    ...
                    b.HasOne("DysonNetwork.Shared.Models.SnPost", "Post")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_collection_items_posts_post_id");
            ...
            modelBuilder.Entity("DysonNetwork.Shared.Models.SnSurveySubscription", b =>
                {
                    b.HasOne("DysonNetwork.Shared.Models.SnSurvey", "Survey")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_survey_subscriptions_surveys_survey_id");
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnLiveStreamAward", b =>
                {
                    b.HasOne("DysonNetwork.Sphere.Models.SnLiveStream", "LiveStream")
                        .WithMany()
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnPostIndex", b =>
                {
                    b.HasOne("DysonNetwork.Shared.Models.SnPost", "Post")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_indices_posts_post_id");
            ...
            modelBuilder.Entity("DysonNetwork.Sphere.Models.SnPublisherVerifiedDomain", b =>
                {
                    b.HasOne("DysonNetwork.Shared.Models.SnPublisher", "Publisher")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_publisher_verified_domains_publishers_publisher_id");
